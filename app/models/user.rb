class User < ApplicationRecord
  ...
  has_secure_password
  validates :password, presence: true, length: {minimum: Settings.password.minimum_length}, allow_nil: true
  ...
  def feed
    Micropost.find_user_id(following_ids, id).order_by_created_at
  end
